...
const LandSectionPayment = ({ id, Name, Number, Code, data }) => {
  var Data = data;
  const [sendTrueOrFalse, setSendTrueOrFalse] = useState(
    Data.IsCalledWithHomeOwnThirdStep
  );
  const [isButtonTwoClicked, setIsButtonTwoClicked] = useState(
    Data.IsCalledWithCustomerFirstStep
  );
  const [isButtonThreeClicked, setIsButtonThreeClicked] = useState(
    Data.IsPaidHomeOwnFirstStep
  );
  const [isButtonFourClicked, setIsButtonFourClicked] = useState(
    Data.IsPaidCustomerFirstStep
  );
    ...
    <div className="col-md-4 col-sm-6 col-12 col-lg-3">
      <div className=" p-2 mt-4">
        <div className="card-home">
          ...
          <div className="pb-2">
            <Link to={`/homelogin/MainAdmin/Land/Payment/Kart/${id}`}>
              <p>
                Ev sahibi:<span>{Name}</span>
              </p>
              <p>
                Kod:<span>{Code}</span>
              </p>
              <p>
                Nömrəsi:<span>{Number}</span>
              </p>
            ...
            <div className=" d-flex flex-wrap">
              ...
              >
                {" "}
                Ev sahibi <br /> ilə danışıldı
              </button>
              <button
                className="btn col-5"
                style={buttonTwoStyle}
                onClick={handleTwoButtonClick}
              >
                Müştərilə <br /> danışıldı
              </button>
              <button
...
export default LandSectionPayment;
