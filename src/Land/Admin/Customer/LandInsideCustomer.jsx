...
const LandInsideCustomer = () => {
  ...
  const addCustomer = () => {
    ...
    if(customerObject.FullName.length>0 &&  !isNaN(parseFloat(customerObject.Number))){
      const AddItem = async () => {
        await FetchPostCustomer(customerObject, "LandCustomer");
      };
      AddItem();
      ...
      <div className="insideCard-home">
        ...
        {getById && (
          <div className="pb-2 mt-3">
            ...
            <div className="mt-3">
              {" "}
              <GetBack Direct={"/HomeLogin/MainAdmin/Land/customer"} />
            </div>
          </div>
        )}
      </div>
...
export default LandInsideCustomer