            ...
            <div className=' col-12 p-2 mt-4 ps-2'>
                <div className='insideCard-home'>
                    ...
                    <div className='pb-2 mt-3'>
                        ...
                        <div className="col-12 d-flex justify-content-center mt-2 h-25">
                            <div className="h-25 ">
                                <input type="Text" placeholder="Müştərinin adı soyadı:" />
                                <input type="number" placeholder="Nömrəs:" />
                                <button className='btn btn-success'> Əlavə etmək</button>
                            </div>
