...
import { fetchData, setPage } from '../Redux/ObyektGet';
const CardsObyekt = () => {
  Scroll();
  ...
  const GetData = useSelector((state) => state.Obyekt.data);
  const currentPageR = useSelector((state) => state.Obyekt.currentPage);
  const totalPages = useSelector((state) => state.Obyekt.totalPages);
  const hasFetched = useSelector((state) => state.Obyekt.hasFetched);
  const SearchFalse = useSelector((state) => state.Obyekt.SearchBool);
  const SearchRedux = useSelector((state) => state.Obyekt.SearchModel);
