...
export const fetchData = createAsyncThunk(
  ...
  async ({ page ,SearchModel,Number}) => {
    ...
    switch (SearchModel) {
      case 'id':
        response = await FetchGetAll(`RentHome/AdminId-${Number}`);
        return response.data;
      case 'AdminONumber':    
        response = await FetchGetAll(`RentHome/AdminONumber-${stringNumber}`);
        return response.data;
      case 'AdminCNumber':
        response = await FetchGetAll(`RentHome/AdminCNumber-${stringNumber}`);
        return response.data;
      default:
        response = await FetchGetAll(`RentHome/Normal-${page}`);
        return response.data;
    }
  }
);
