...
export const fetchData = createAsyncThunk(
  ...
  async ({ page ,SearchModel,Number}) => {
    ...
    switch (SearchModel) {
      case 'id':
        response = await FetchGetAll(`Land/AdminId-${Number}`);
        return response.data;
      case 'AdminONumber':    
        response = await FetchGetAll(`Land/AdminONumber-${stringNumber}`);
        return response.data;
      case 'AdminCNumber':
        response = await FetchGetAll(`Land/AdminCNumber-${stringNumber}`);
        return response.data;
      default:
        response = await FetchGetAll(`Land/Normal-${page}`);
        return response.data;
    }
  }
);
