...
const OfficeSectionOwn = ({props}) => {
  ...
  const recommendSell = () => {
    ...
    const PutData=async()=>{
      await FetchPut(Data,"Office/Recommend");
     }
     PutData();
  };
  const buttonStyle = {
    ...
    <div className='col-md-4 col-sm-6 col-12 col-lg-3'>
         <div className=' p-2 mt-4'>
            <div className='card-home'>
                ...
                <div className='pb-2'><Link to={`/Homelogin/MainAdmin/Office/Own/Kart/${props.Id}`}>
...
export default OfficeSectionOwn