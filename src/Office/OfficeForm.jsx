...
const OfficeForm = ({ Data, IsUpdating, SendFalse}) => {
        ...
        <div className="d-flex flex-column align-items-center ">
          <div className="col-5">
            <p className="text-center text-danger">
              <strong>
                Yalnız ofis sahibləri elan yerləşdirə bilər.
                <br />
          ...
          <div className="col-12">
            <div>
              <p>
                {" "}
                <strong>
                Ofisinizi satmaq və ya kiraye vermək üçün aşağıdakı sualları
                  cavablandırın:
                </strong>
              </p>
            </div>
          ...
          <div className="col-12">
            <div>
              <div className="div-in-label">
                ...
                <span className="attention">* </span>Ofis sahibinin adı və Soyadı:
                </label>
              </div>
            ...
            <div>
            <WarningComp warning={warning} StringName={"FullNameWarn"} Text={"Ofis sahibinin adı və soyadı daxil edilməlidir."}/>
            ...
            <div className="mt-3">
              <div className="div-in-label">
                <label htmlFor="customerName">
                <span className="attention">* </span>Ofis sahibinin əlaqə nömrəsi:(Nömrəniz gizli saxlanılacaq)
                </label>
              </div>
              <div className="col-12 div-in-input">
            ...
            <div>
            <WarningComp warning={warning} StringName={"NumberWarn"} Text={"Ofis sahibinin əlaqə nömrəsi daxil edilməlidir."}/>
            <WarningComp warning={warning} StringName={"isNaNNumberWarn"} Text={"Ofis sahibinin əlaqə nömrəsi rəqəmlərlə daxil edilməlidir."}/>
            <WarningComp warning={warning} StringName={"NumberLengthWarn"} Text={"Daha qısa əlaqə nömrəsi daxil edilməlidir."}/>
            </div>
            <div>
              <div className="d-flex flex-column align-items-center mt-3">
                <p className="text-danger fs-5">
                  * Ofisinizə aid 5-10 şəkil əlavə edin.
                </p>
            ...
            <div className="mt-3">
              <div className="div-in-label">
                <label htmlFor="customerName"><span className="attention">* </span>Ofisin yerləşdiyi rayon:</label>
              </div>
            ...
            <div>
            <WarningComp warning={warning} StringName={"RegionWarn"} Text={"Ofisin yerləşdiyi rayon daxil edilməlidir."}/>
            <WarningComp warning={warning} StringName={"RegionLengthWarn"} Text={"Daha qısa rayon adı daxil edilməlidir."}/>
            </div>
            <div className="mt-3">
              <div className="div-in-label">
                <label htmlFor="customerName">
                <span className="attention">* </span>Ofisin yerləşdiyi küçənin adı:
                </label>
              </div>
              <div className="col-12 div-in-input">
            ...
            <div>
            <WarningComp warning={warning} StringName={"AddressWarn"} Text={"Ofisin yerləşdiyi ünvan daxil edilməlidir."}/>
            ...
            <div className="mt-3">
              <div className="div-in-label">
                ...
                <span className="attention">* </span>Ofisinizi satırsınız yoxsa kiraye verirsiniz:
                </label>
              </div>
              <div className="col-12 div-in-select">
            ...
            <div>
            <WarningComp warning={warning} StringName={"SellorRentWarn"} Text={"Seçim edin."}/>
            ...
            <div className="mt-3">
              <div className="div-in-label">
                <label htmlFor="customerName"><span className="attention">* </span>Ofisin qiyməti:</label>
              </div>
              <div className="col-12 div-in-input">
            ...
            <div>
            <WarningComp warning={warning} StringName={"PriceWarn"} Text={"Ofisin qiyməti daxil edilməlidir."}/>
            <WarningComp warning={warning} StringName={"isNaNPriceWarn"} Text={"Ofisin qiyməti rəqəmlərlə daxil edilməlidir."}/>
            ...
            <div className="mt-3">
              ...
              <div className="col-12 div-in-select">
                <select name="" id="" ref={Item}>
                  <option value=""></option>
                  <option value="Obyektin içərisi boşdur.">Ofisin içərisi boşdur.</option>
                  <option value="Bəzi əşya ilə birlikdə verilir.">Ofisdə bəzi əşyalar var.</option>
                  <option value="Obyektdə bütün əşyalar var.">Ofisdə bütün əşyalar var.</option>
                </select>
              </div>
            </div>
            <div>
            ...
            <div className="mt-3">
            <p><span className="attention">* </span>Ofisin konumunu qeyd edin.</p>
            ...
            <div>
            <WarningComp warning={warning} StringName={"MetroWarn"} Text={"Ofisə yaxın metro adı daxil edilməlidir."}/>
            ...
            <div>
            <WarningComp warning={warning} StringName={"RepairWarn"} Text={"Seçim edin."}/>
            <WarningComp warning={warning} StringName={"RepairLengthWarn"} Text={"Daha qısa ad daxil edilməlidir."}/>
            </div>
            <div className="mt-3">
              <div className="div-in-label">
                <label htmlFor="customerName"><span className="attention">* </span>Ofisin sahəsi: (m²)</label>
              </div>
              <div className="col-12 div-in-input">
            ...
            <div>
            <WarningComp warning={warning} StringName={"AreaWarn"} Text={"Ofisin sahəsi daxil edilməlidir."}/>
            <WarningComp warning={warning} StringName={"isNaNAreaWarn"} Text={"Ofisin sahəsi rəqəmlərlə daxil edilməlidir."}/>
            <WarningComp warning={warning} StringName={"AreaLengthWarn"} Text={"Daha az sahə daxil edilməlidir."}/>
            </div>
            <div className="mt-3">
              <div className="div-in-label">
                <label htmlFor="customerName">
                Ofis haqqında əlavə məlumat yaza bilərsiniz:
                </label>
              </div>
              <div className="col-12 div-in-input">
